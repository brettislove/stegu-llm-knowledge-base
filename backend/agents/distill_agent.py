...
You turn raw human feedback into permanent improvements, per SCHEMA.md §6-7.
...
Rules:
- Never touch index.md or log.md — those belong to the ingest agent only.
...
def _dispatch(tool_name: str, tool_input: dict) -> str:
    ...
    if tool_name == "write_file":
        ...
        if path in {"index.md", "log.md"}:
            raise PermissionError("The distill agent is not permitted to write index.md or log.md.")
